...
| 文件 | 作者与许可 | 修改与用途 |
| --- | --- | --- |
| models/teddy-apricot.glb / teddy-cream.glb | 项目原创，Blender 制作 | 连续雕塑网格、卷毛法线、骨骼、眨眼与四组动作 |
...
| models/jazz-duo.glb | Quaternius，CC0 基础人物和服装 | 重新配色、双人舞步编排与舞台装配；具体上游文件和许可见模型目录 |
